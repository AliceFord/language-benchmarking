...
class Tests:
    ...
    def __a005132(self, ntop):  # Generate N of series a005132
        def func(n):
            if n == 0:
                return 0
            else:
    ...
    def __a002113(self, n):  # Generate a002113 UP TO n
        output = []
        for i in range(n+1):
            rstr = str(i)
            if rstr == rstr[::-1]:
    ...
    def __a000040(self, n):  # Generate a000040 UP TO n, using sieve of eratosthenes
    ...
    def __a005150(self, ntop):  # Generate N of sequence a005150
    ...
    def __a000045(self, ntop):  # Generate N of sequence a000045
        def F(n):
            if n > 1:
                return F(n-1) + F(n-2)
            return 1
